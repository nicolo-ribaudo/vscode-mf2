...
// source-hash: 71de716e1cc0d3524a3f3df52774a9537dc73625
let wasm;
...
const WasmServerFinalization = (typeof FinalizationRegistry === "undefined")
  ? { register: () => {}, unregister: () => {} }
  : new FinalizationRegistry((ptr) => wasm.__wbg_wasmserver_free(ptr >>> 0));
/** */
class WasmServer {
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
    WasmServerFinalization.unregister(this);
    return ptr;
  }

  free() {
    const ptr = this.__destroy_into_raw();
    wasm.__wbg_wasmserver_free(ptr);
  }
  /** */
  constructor() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.wasmserver_new(retptr);
  ...
  write(value) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.wasmserver_write(retptr, this.__wbg_ptr, addHeapObject(value));
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
      if (r2) {
   ...
   */
  read() {
    const ret = wasm.wasmserver_read(this.__wbg_ptr);
    return takeObject(ret);
  }
}
module.exports.WasmServer = WasmServer;
...
async function instantiateWithInstance(opts) {
  const { instance } = await loader.load(
    opts?.url ?? new URL("mf2lsp_bg.wasm", toFileUrl(__filename)),
    opts?.decompress,
  );
...
module.exports.instantiateWithInstance = instantiateWithInstance;
...
module.exports.isInstantiated = isInstantiated;

async function cacheToLocalDir(url, decompress) {
...
module.exports.cacheToLocalDir = cacheToLocalDir;
...
module.exports.getUrlLocalPath = getUrlLocalPath;
...
module.exports.fetchWithRetries = fetchWithRetries;
